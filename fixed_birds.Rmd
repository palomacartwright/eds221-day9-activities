...
**MAKE A COPY** of this file called 'fixed_birds.Rmd' that you'll work in. That way you have the original version in case you really bork something and want to get revert. 
...
The code below joins the site information to `birds_df`, then groups by `park_name`, then finds the sum of the `bird_count` column. The top 15 values are retained, and the park_name converted to an ordered factor by total count. 
